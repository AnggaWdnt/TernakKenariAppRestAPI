...
class AdminProfile {
  ...
  AdminProfile({this.id, this.name});

  factory AdminProfile.fromJson(String str) =>
      AdminProfile.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AdminProfile.fromMap(Map<String, dynamic> json) =>
      AdminProfile(id: json["id"], name: json["name"]);
